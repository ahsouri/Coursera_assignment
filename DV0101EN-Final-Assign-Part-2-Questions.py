...
#Plot 1 Automobile sales fluctuate over Recession Period (year wise)
        ...
        R_chart1 = dcc.Graph(
            figure=px.line(
                ...
                x='Year', 
                y='Automobile_Sales',
                title="Average Automobile Sales During Recession Period (Yearly)"
            )
        )
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
    ...
    #  Plot 1: Yearly Automobile sales over all years (line chart)
        yas = data.groupby('Year')['Automobile_Sales'].mean().reset_index()
        Y_chart1 = dcc.Graph(
            figure=px.line(
                yas,
                x='Year',
                y='Automobile_Sales',
                title='Yearly Average Automobile Sales Over All Years'
        )
        )
    ...
    #  Plot 4: Pie chart for total ad expenditure by vehicle type
